...
def runAllRotateTests():
  ...
  case6 = (
     ...
     [np.array([4], dtype=np.int8), 
      np.array([3,8], dtype=np.int8), 
      np.array([2, 7, 12], dtype=np.int8), 
      np.array([1, 6, 11, 16], dtype=np.int8),
      np.array([5, 10, 15], dtype=np.int8),
      np.array([9, 14], dtype=np.int8),
  ...
  case7 = (
     ...
     [np.array([1], dtype=np.int8), 
      np.array([5,2], dtype=np.int8), 
      np.array([9, 6, 3], dtype=np.int8), 
      np.array([13, 10, 7, 4], dtype=np.int8),
      np.array([14, 11, 8], dtype=np.int8),
      np.array([15, 12], dtype=np.int8),
      np.array([16], dtype=np.int8)]
  )
